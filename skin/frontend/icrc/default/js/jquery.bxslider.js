	...
	$.fn.bxSlider = function(options){
		...
		var setup = function(){
			...
			if(slider.settings.mode == 'fade'){
				...
				slider.children.eq(slider.settings.startSlide).css({zIndex: 9, display: 'block'});
			}
		...
		el.goToSlide = function(slideIndex, direction){
			...
			if(slider.settings.mode == 'fade'){
				...
				slider.children.eq(slider.active.index).css('zIndex', 10).fadeIn(slider.settings.speed, function(){
					$(this).css('zIndex', 9);
					updateAfterSlideTransition();
				});
