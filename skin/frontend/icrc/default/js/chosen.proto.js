  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.result_add_option = function(option) {
      ...
      if (!option.disabled) {
        ...
        //return '<li id="' + option.dom_id + '" class="' + classes.join(' ') + '"' + style + '><a href="'+option.value+'">' + option.html2 + '</a></li>';
	return '<li id="' + option.dom_id + '" class="' + classes.join(' ') + '"' + style + '>' + option.html2 + '</li>';
      } else {
        return "";
      }
    };
...
(function() {
  ...
  Chosen = (function(_super) {
	...
	{
        data = _ref[_i];
        data.html2 = '<a href="'+data.value+'">'+data.html+'</a>'
        if (data.group)
        	{
