 ...
 */
class Data_Icrc_Model_Server_Soapadapter extends Mage_Api_Model_Server_Adapter_Soap
{
    /**
     * Run webservice
     *
    ...
    protected function _instantiateServer()
    {
        ...
        do {
            $retry = false;
            try {
                $this->_soap = new Data_Icrc_Model_Server_Soap($this->getWsdlUrl(array("wsdl" => 1)),
