...
function recordAttr_39($setup, $attributes, $set = null) {
...
$langs = array('languages_available', 'multiselect', null, true, 'values' => array('English', 'French', 'Spanish', 'Arabic', 'Russian', 'Chinese', 'Portuguese'));
recordAttr_39($setup, array('Languages Available' => $langs));
